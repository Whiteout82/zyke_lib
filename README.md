...
-   [functions/getItemDurability/shared.lua](functions/getItemDurability/shared.lua)
...
-   [functions/setItemDurability/server.lua](functions/setItemDurability/server.lua)
